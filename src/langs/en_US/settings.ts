...
export const settings: AppDictionary["settings"] = {
  ...
  updates: {
    ...
    channelDescription:
      "Choose which builds to receive. Canary delivers the latest test builds, which may be unstable.",
    channelRelease: "Release",
    channelReleaseDescription: "Stable builds recommended for everyday use.",
    channelCanary: "Canary",
    channelCanaryDescription: "Latest test build. May be unstable and ships more frequently.",
    ...
    errorGeneric: "Could not complete the update operation.",
  },
  editor: {
