...
export const home: AppDictionary["home"] = {
  ...
  connections: {
    ...
    emptyDescription:
      "Adicione uma conexão para abrir terminal SSH, explorar arquivos SFTP e criar workspaces por protocolo.",
    openSsh: "Abrir SSH",
