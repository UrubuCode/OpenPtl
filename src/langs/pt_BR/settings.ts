...
export const settings: AppDictionary["settings"] = {
  ...
  updates: {
    ...
    channelDescription:
      "Escolha quais builds receber. O canal Canary entrega os builds de teste mais recentes, que podem ser instáveis.",
    channelRelease: "Estável",
    channelReleaseDescription: "Builds estáveis recomendados para o uso diário.",
    channelCanary: "Canary",
    channelCanaryDescription: "Build de teste mais recente. Pode ser instável e é publicado com mais frequência.",
    checkButton: "Verificar atualizações",
    checking: "Verificando...",
    upToDate: "Você está atualizado (v{version}).",
    updateAvailable: "Atualização disponível: v{version}",
    installButton: "Instalar atualização",
    installing: "Instalando...",
    notesLabel: "Notas da versão",
    errorGeneric: "Não foi possível concluir a operação de atualização.",
  },
  editor: {
    title: "Editor padrão",
